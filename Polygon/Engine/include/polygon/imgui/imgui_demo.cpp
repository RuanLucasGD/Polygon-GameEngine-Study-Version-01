...
// Play it nice with Windows users (UpdateGame: May 2018, Notepad now supports Unix-style carriage returns!)
#ifdef _WIN32
#define IM_NEWLINE  "\r\n"
#else
#define IM_NEWLINE  "\n"
...
static void ShowDemoWindowTables()
{
	...
	if (ImGui::TreeNode("Advanced"))
	{
		...
		// UpdateGame item list if we changed the number of items
		static ImVector<MyItem> items;
