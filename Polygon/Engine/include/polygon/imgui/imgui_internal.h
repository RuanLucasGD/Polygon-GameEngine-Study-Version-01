...
#ifdef _WIN32
#define IM_NEWLINE                      "\r\n"   // Play it nice with Windows users (UpdateGame: since 2018-05, Notepad finally appears to support Unix-style carriage returns!)
#else
#define IM_NEWLINE                      "\n"
#endif
#define IM_TABSIZE                      (4)
...
struct IMGUI_API ImGuiDockNode
{
	...
	bool                    MarkedForPosSizeWrite : 1; // UpdateGame by DockNodeTreeUpdatePosSize() write-filtering
...
namespace ImGui
{
	...
	IMGUI_API void          LogToBuffer(int auto_open_depth = -1);                      // StartGame logging/capturing to internal buffer
