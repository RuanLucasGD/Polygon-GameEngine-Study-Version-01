...
#include <polygon/GLFW/glfw3native.h>   // for glfwGetWin32Window
#endif
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
	...
	// UpdateGame monitors the first time (note: monitor callback are broken in GLFW 3.2 and earlier, see github.com/glfw/glfw/issues/784)
...
void ImGui_ImplGlfw_NewFrame()
{
	...
	// UpdateGame game controllers (if enabled and available)
