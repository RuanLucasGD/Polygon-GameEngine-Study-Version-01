...
#endif
#include <polygon/glm/gtx/dual_quaternion.hpp>
#include <polygon/glm/gtc/vec1.hpp>
#include <polygon/glm/gtc/quaternion.hpp>
#include <polygon/glm/ext/scalar_int_sized.hpp>
#include <polygon/glm/ext/scalar_uint_sized.hpp>
